...
namespace SD {
public class CharacterSelectionCameraController : MonoBehaviour {
    ...
    void Start(){
        ...
        playerPosition = GameObject.FindGameObjectWithTag ("CharacterSelectionPlayer").transform.position;
